...
export const assetOpStatusEnum = pgEnum("asset_op_status", [
  "operative",
  "maintenance",
  "breakdown",
  "decommissioned",
...
export const users = pgTable("users", {
  ...
  isMustChangePassword: boolean("is_must_change_password")
    .default(true)
    .notNull(),
...
export const assets = pgTable("assets", {
  ...
  isManualCategory: boolean("is_manual_category").default(false).notNull(),
  ...
  operationalStatus:
    assetOpStatusEnum("operational_status").default("operative"),
