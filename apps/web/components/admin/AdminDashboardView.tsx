  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        >
          Welcome back. Here is a real-time summary of your enterprise portfolio
          and asset inventory.
        </p>
      </div>
            ...
            {stats.recentAssets.length > 0 ? (
              stats.recentAssets.map((asset) => (
                ...
                >
                  ...
                  >
                    {asset.assetName || "Untitled Asset"} {/* 👈 Fixed */}
                  </td>
                  <td style={{ padding: "0.75rem 1.5rem", color: "#64748b" }}>
                    {asset.assetCode || "N/A"} {/* 👈 Fixed */}
                  </td>
                  <td style={{ padding: "0.75rem 1.5rem", color: "#475569" }}>
                    {asset.categoryName || "Uncategorized"} {/* 👈 Fixed */}
                  </td>
                  <td style={{ padding: "0.75rem 1.5rem", color: "#64748b" }}>
                    {asset.createdAt
